...
{
    /// <summary>
    /// Event arguments for the <see cref="IBAutomater.OutputDataReceived"/> event.
    /// </summary>
    public sealed class OutputDataReceivedEventArgs : EventArgs
    {
        ...
        /// </summary>
        /// <param name="data">The output message</param>
        public OutputDataReceivedEventArgs(string data)
        {
            Data = data;
        }
    }
